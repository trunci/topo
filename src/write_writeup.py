...
magnitude as a circuit attributor. The durable contribution is the **adversarial,
...
## 18. Follow-up research directions
...
exp9b_length, and exp11). Regenerate this document with `uv run python -m src.write_writeup`.
"""
...
def main(spike="results/real_stats.json", exp1="results/exp1_stats.json",
    ...
    open(out, "w").write(build(s, e, x, r, g, p, q, qs, qm, h, z, za, zk, zl, zm, zn))
    print(f"wrote {out}")
