...
(Mistral-7B / HotpotQA), the identical features sit at chance (AUC 0.494, vs
...
gold contexts (0.499). The regime where hand-specified attention topology beats
...
END→IO edge produces damage 0.513, p = 0.000050; n = 48), no saliency beats
random at small budgets: cycle 0.028 (p = 0.276), magnitude -0.132, sheaf
-0.187. The instrument works; the saliencies don't.
...
0.681 (ΔAUC = 0.245, p = 0.0312); at five hops, 1.000 vs
...
bridge questions, full 10-paragraph distractor contexts, n = 200, accuracy
...
0.617 at hop 5). TOHA's 0.71 on open-domain QA shows engineered
