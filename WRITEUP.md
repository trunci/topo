...
0.681 (Exp 13, P, GREEN). Two contributions are novel relative to concurrent
...
near its capability ceiling (P — accuracy 0.525, topology AUC 0.930 vs confidence
0.681, GREEN in all 3 seeds and both models tested). As an **attributor**, topology
